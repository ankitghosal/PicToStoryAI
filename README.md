...
AI tool that generates an Audio short story based on the context of an uploaded image by prompting a GenAI LLM model, Hugging Face AI models together with Gemini API &amp; LangChain. Deployed on Streamlit & Hugging Space Cloud Separately.

## 📢Run App with Streamlit Cloud

[Launch App On Streamlit](https://pictostory.streamlit.app/)


## 🎯 Demo:
![Demo 1: Couple Hug Test Image Output](img-audio/Couplehug.jpg)
...
- **Text to story:**
  ChatGoogleGenerativeAI LLM model is prompted to create a short story (50 words: can be adjusted as reqd.) based on the generated scenario. [gemini-2.5-flash-lite](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/models/gemini/2-5-flash-lite)
- **Story to speech:**
...
![Demo 3: Quality Time Test Image Output](img-audio/qualitytime.jpg)
